...
def picking_an_item():
    ...
    print(f'your choice : {user_input} | system input : {system_input}')
    print(f'your score : {human_score} | system score : {system_score}')


if int(number_of_rounds) >= 1 and number_of_rounds.isnumeric() and int(number_of_rounds) % 2 != 0:
